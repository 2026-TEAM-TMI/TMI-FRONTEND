...
export default function PortfolioListItem({ portfolio: p, onClick }: PortfolioListItemProps) {
  return (
    <div
      onClick={onClick}
      className="rounded-[20px] p-7 bg-white border-[1.5px] border-surface-container shadow-[0_2px_12px_rgba(99,71,209,0.06)] hover:shadow-[0_8px_32px_rgba(99,71,209,0.14)] hover:-translate-y-0.5 hover:border-outline-variant transition-all duration-200 cursor-pointer"
    >
