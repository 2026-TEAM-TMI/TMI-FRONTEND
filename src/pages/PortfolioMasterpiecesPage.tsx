...
const masterpieces: Masterpiece[] = [
  { id: 1, title: "Lumina: Generative Dreamscapes", desc: "생성형 AI 기반 감성 추천 엔진. 사용자 감정 임베딩을 실시간으로 분석하여 콘텐츠를 큐레이션합니다.", tags: ["PyTorch", "LangChain", "FastAPI", "Redis"], likes: "1.2k", comments: "284", gradient: "linear-gradient(135deg, #6347d122 0%, #9c48ea33 100%)", accent: "#6347d1" },
  { id: 2, title: "Ethos: Multimodal Sentiment Pipeline", desc: "텍스트·이미지·오디오 멀티모달 감성 분류 모델. ONNX 변환 후 Ray Serve로 고가용성 서빙.", tags: ["Transformers", "ONNX", "Ray Serve", "Docker"], likes: "3.4k", comments: "1.1k", gradient: "linear-gradient(135deg, #4b2ab822 0%, #6347d133 100%)", accent: "#4b2ab8" },
  { id: 3, title: "Astro Analytics: AI Performance Dashboard", desc: "모델 드리프트 자동 탐지 및 MLOps 대시보드. Prometheus + Grafana 연동으로 실시간 모니터링.", tags: ["MLflow", "Prometheus", "Grafana", "Python"], likes: "892", comments: "204", gradient: "linear-gradient(135deg, #8127cf22 0%, #4b2ab833 100%)", accent: "#8127cf" },
];
